...
def seed():
    ...
    # =========================================================================
    # SẢN PHẨM — 12 danh mục × 5 sản phẩm = 60 sản phẩm
    #             sắp xếp theo giá tăng dần trong mỗi danh mục
    # =========================================================================
    products = [
        ...
        Product(sku="RAM-GSKILL-16GB-DDR4",   name="G.Skill Ripjaws V 16GB DDR4 3600",  category="RAM", brand="G.Skill",  price=1_090_000, stock=18, warranty_months=36),
        ...
        # --- SSD (5) ---
        Product(sku="SSD-KINGSTON-A400-480",  name="Kingston A400 480GB SATA SSD",   category="SSD", brand="Kingston",        price=590_000,   stock=22, warranty_months=36),
        ...
        Product(sku="VGA-AMD-RX7600",      name="AMD Radeon RX 7600 8GB",              category="VGA", brand="AMD",      price=7_490_000,  stock=7, warranty_months=36),
        ...
        # --- PSU (5) ---
        Product(sku="PSU-CM-ELITE500",       name="Cooler Master Elite 500W 80 Plus",   category="PSU", brand="Cooler Master", price=890_000,   stock=14, warranty_months=36),
        ...
        Product(sku="MAIN-ASROCK-B660M",    name="ASRock B660M Pro RS DDR4",        category="Mainboard", brand="ASRock",   price=2_190_000, stock=10, warranty_months=36),
        ...
        # --- Case (5) ---
        Product(sku="CASE-CM-Q300L",       name="Cooler Master MasterBox Q300L", category="Case", brand="Cooler Master", price=790_000,   stock=15, warranty_months=12),
        ...
        # --- Cooler (5) ---
        Product(sku="COOLER-TR-AX120",       name="Thermalright Assassin X 120 R SE", category="Cooler", brand="Thermalright", price=390_000,   stock=16, warranty_months=12),
        Product(sku="COOLER-CM-H212",         name="Cooler Master Hyper 212 Black",   category="Cooler", brand="Cooler Master", price=590_000,   stock=14, warranty_months=12),
    ...
    # =========================================================================
    # ĐƠN HÀNG (38) — nhóm theo khách hàng, đa dạng trạng thái
    # =========================================================================
    orders = [
        # Phạm Minh Tuấn (5 đơn — khách thường xuyên)
        Order(order_code="ORD001", customer_id=tuan.id, product_id=p["Intel Core i5 12400F"],              product_name="Intel Core i5 12400F",              quantity=1, total_amount=3_590_000, status="cancelled",  note="đổi ý sau khi đặt"),
        ...
        Order(order_code="ORD028", customer_id=mai.id,  product_id=p["AMD Ryzen 5 5600"],                   product_name="AMD Ryzen 5 5600",                   quantity=1, total_amount=3_190_000, status="pending",    note="nâng cấp – test hủy đơn"),
        Order(order_code="ORD038", customer_id=mai.id,  product_id=p["Seagate Barracuda 1TB 7200RPM"],      product_name="Seagate Barracuda 1TB 7200RPM",      quantity=1, total_amount=1_050_000, status="pending",    note="HDD lưu trữ"),
